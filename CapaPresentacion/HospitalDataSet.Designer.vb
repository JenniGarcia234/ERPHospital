...
Partial Public Class HospitalDataSet
    ...
    Partial Public Class usuarioDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddusuarioRow(ByVal id_usuario As Integer, ByVal id_empleado As Integer, ByVal nombre_usuario As String, ByVal contraseña As String, ByVal id_funcion As Integer) As usuarioRow
            Dim rowusuarioRow As usuarioRow = CType(Me.NewRow,usuarioRow)
            Dim columnValuesArray() As Object = New Object() {id_usuario, id_empleado, nombre_usuario, contraseña, id_funcion}
        ...
        Private Sub InitClass()
            ...
            Me.columnid_funcion = New Global.System.Data.DataColumn("id_funcion", GetType(Integer), Nothing, Global.System.Data.MappingType.Element)
            ...
            Me.columnnombre_usuario.MaxLength = 15
    ...
    Partial Public Class usuarioRow
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Property id_funcion() As Integer
            Get
                Try 
                    Return CType(Me(Me.tableusuario.id_funcionColumn),Integer)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("El valor de la columna 'id_funcion' de la tabla 'usuario' es DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableusuario.id_funcionColumn) = value
            End Set
        End Property
        ...
        Public Function Isid_empleadoNull() As Boolean
            Return Me.IsNull(Me.tableusuario.id_empleadoColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Sub Setid_empleadoNull()
            Me(Me.tableusuario.id_empleadoColumn) = Global.System.Convert.DBNull
        End Sub
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Function Isid_funcionNull() As Boolean
            Return Me.IsNull(Me.tableusuario.id_funcionColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Sub Setid_funcionNull()
            Me(Me.tableusuario.id_funcionColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
    ...
    Partial Public Class usuarioTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[usuario] WHERE (([id_usuario] = @Original_id_usuario) AND ((@I"& _ 
                "sNull_id_empleado = 1 AND [id_empleado] IS NULL) OR ([id_empleado] = @Original_i"& _ 
                "d_empleado)) AND ((@IsNull_nombre_usuario = 1 AND [nombre_usuario] IS NULL) OR ("& _ 
                "[nombre_usuario] = @Original_nombre_usuario)) AND ((@IsNull_contraseña = 1 AND ["& _ 
                "contraseña] IS NULL) OR ([contraseña] = @Original_contraseña)) AND ((@IsNull_id_"& _ 
                "funcion = 1 AND [id_funcion] IS NULL) OR ([id_funcion] = @Original_id_funcion)))"& _ 
                ""
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@IsNull_id_funcion", Global.System.Data.SqlDbType.Int, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "id_funcion", Global.System.Data.DataRowVersion.Original, true, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_id_funcion", Global.System.Data.SqlDbType.Int, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "id_funcion", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            Me._adapter.InsertCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[usuario] ([id_usuario], [id_empleado], [nombre_usuario], [cont"& _ 
                "raseña], [id_funcion]) VALUES (@id_usuario, @id_empleado, @nombre_usuario, @cont"& _ 
                "raseña, @id_funcion);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT id_usuario, id_empleado, nombre_usuario, contraseñ"& _ 
                "a, id_funcion FROM usuario WHERE (id_usuario = @id_usuario)"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@id_funcion", Global.System.Data.SqlDbType.Int, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "id_funcion", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me._adapter.UpdateCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[usuario] SET [id_usuario] = @id_usuario, [id_empleado] = @id_emplea"& _ 
                "do, [nombre_usuario] = @nombre_usuario, [contraseña] = @contraseña, [id_funcion]"& _ 
                " = @id_funcion WHERE (([id_usuario] = @Original_id_usuario) AND ((@IsNull_id_emp"& _ 
                "leado = 1 AND [id_empleado] IS NULL) OR ([id_empleado] = @Original_id_empleado))"& _ 
                " AND ((@IsNull_nombre_usuario = 1 AND [nombre_usuario] IS NULL) OR ([nombre_usua"& _ 
                "rio] = @Original_nombre_usuario)) AND ((@IsNull_contraseña = 1 AND [contraseña] "& _ 
                "IS NULL) OR ([contraseña] = @Original_contraseña)) AND ((@IsNull_id_funcion = 1 "& _ 
                "AND [id_funcion] IS NULL) OR ([id_funcion] = @Original_id_funcion)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT id"& _ 
                "_usuario, id_empleado, nombre_usuario, contraseña, id_funcion FROM usuario WHERE"& _ 
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@id_funcion", Global.System.Data.SqlDbType.Int, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "id_funcion", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@IsNull_id_funcion", Global.System.Data.SqlDbType.Int, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "id_funcion", Global.System.Data.DataRowVersion.Original, true, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_id_funcion", Global.System.Data.SqlDbType.Int, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "id_funcion", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT id_usuario, id_empleado, nombre_usuario, contraseña, id_funcion FROM dbo.u"& _ 
                "suario"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_id_usuario As Integer, ByVal Original_id_empleado As Global.System.Nullable(Of Integer), ByVal Original_nombre_usuario As String, ByVal Original_contraseña As String, ByVal Original_id_funcion As Global.System.Nullable(Of Integer)) As Integer
            ...
            End If
            If (Original_id_funcion.HasValue = true) Then
                Me.Adapter.DeleteCommand.Parameters(7).Value = CType(0,Object)
                Me.Adapter.DeleteCommand.Parameters(8).Value = CType(Original_id_funcion.Value,Integer)
            Else
        ...
        Public Overloads Overridable Function Insert(ByVal id_usuario As Integer, ByVal id_empleado As Global.System.Nullable(Of Integer), ByVal nombre_usuario As String, ByVal contraseña As String, ByVal id_funcion As Global.System.Nullable(Of Integer)) As Integer
            ...
            End If
            If (id_funcion.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(4).Value = CType(id_funcion.Value,Integer)
            Else
        ...
        Public Overloads Overridable Function Update(ByVal id_usuario As Integer, ByVal id_empleado As Global.System.Nullable(Of Integer), ByVal nombre_usuario As String, ByVal contraseña As String, ByVal id_funcion As Global.System.Nullable(Of Integer), ByVal Original_id_usuario As Integer, ByVal Original_id_empleado As Global.System.Nullable(Of Integer), ByVal Original_nombre_usuario As String, ByVal Original_contraseña As String, ByVal Original_id_funcion As Global.System.Nullable(Of Integer)) As Integer
            ...
            End If
            If (id_funcion.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(4).Value = CType(id_funcion.Value,Integer)
            Else
            ...
            If (Original_id_funcion.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(13).Value = CType(Original_id_funcion.Value,Integer)
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal id_empleado As Global.System.Nullable(Of Integer), ByVal nombre_usuario As String, ByVal contraseña As String, ByVal id_funcion As Global.System.Nullable(Of Integer), ByVal Original_id_usuario As Integer, ByVal Original_id_empleado As Global.System.Nullable(Of Integer), ByVal Original_nombre_usuario As String, ByVal Original_contraseña As String, ByVal Original_id_funcion As Global.System.Nullable(Of Integer)) As Integer
            Return Me.Update(Original_id_usuario, id_empleado, nombre_usuario, contraseña, id_funcion, Original_id_usuario, Original_id_empleado, Original_nombre_usuario, Original_contraseña, Original_id_funcion)
        End Function
    End Class
