...
Public Class RegistrarSituacion
    ...
    Private Sub btn_Registrar_Click(sender As Object, e As EventArgs) Handles btn_Registrar.Click
        ...
        Dim idlocalizacion As Integer = Convert.ToInt32(comboBox2.SelectedValue)
        ...
        If funciones.InsertarSituacion(log) Then
            MsgBox("REGISTRO ALMACENADO")
            Limpiar()
        End If
    End Sub

    Private Sub RegistrarSituacion_Load(sender As Object, e As EventArgs) Handles MyBase.Load
