...
Public Class ActualizarHabitacion
    Private Sub ActualizarHabitacion_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btn_Actualizar_Click(sender As Object, e As EventArgs) Handles btn_Actualizar.Click
        ...
        If funciones.ActualizarHabitacion(log) Then
    ...
    Private Sub btn_Buscar_Click(sender As Object, e As EventArgs) Handles btn_Buscar.Click
        ...
        If funciones.BuscarHabitacion(logica) Then
            ...
            Me.comboBox2.Text = logica.gId_piso
